            ...
            <div class="row justify-content-lg-between">
                <div class="col-lg-4 col-md-4 col-sm-12 col-sm-12">
                    <div class="footer_about" data-aos="fade-up" data-aos-delay="100">
                        <div class="brand_logo mb_30"><a href="index.html"><img src="{{asset('project_website/assets/images/logo/logo_02_1x.png')}}" srcset="{{asset('project_website/assets/images/logo/logo_02_2x.png 2x')}}" alt="logo_not_found"></a></div>
                        <p class="mb_15">Cras sit amet mi non orci pretium consectetur. Donec iaculis ante ac sollicitudin luctus. Phasellus ut lacus lacus. Phasellus sagittis ex id tortor tincidunt luctus. Donec consectetur consequat bibendum</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-sm-12">
                    <div class="footer_contact_info" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <ul class="ul_li_block clearfix">
                            ...
                            <li><i class="fas fa-envelope"></i> <strong><a href="https://html.merku.love/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d1a3bea5bea3a2b4bcbd91b4bcbdffb7a3">[email&#160;protected]</a></strong></li>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <p class="copyright_text mb-0">Copyright © 2022. catering king </p>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
